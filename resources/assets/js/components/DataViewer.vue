    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div>
                ...
                <button class="btn btn-warning btn-sm" @click="showFilter = !showFilter">F</button>
            </div>
        </div>
        <div class="panel-body">
            <div class="filter" v-if="showFilter">
                ...
                <div class="filter-btn">
                    <button class="btn btn-success btn-sm btn-block" @click="fetchData">Filter</button>
                </div>
            </div>
        ...
        <div class="panel-footer pagination-footer">
            ...
            <div class="pagination-item">
                <button @click="prev" class="btn btn-primary btn-sm">Prev</button>
